import {ajv, validateAndThrow} from 'in3-common/js/src/util/validate'
...
export interface ServerList {
    ...
    /**
     * registryId of the contract for signing requests
     */
    registryId?: string // ^0x[0-9a-fA-F]+$
    /**
     * number of servers
     */
    totalServers?: number
